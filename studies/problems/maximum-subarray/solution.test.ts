...
const cases = [
  {
    name: "returns the first sample result when every value is positive",
    input: [1, 2, 3, 4],
    expected: [10, 10],
  },
  {
    name: "returns the second sample result when skipping a negative helps the subsequence",
    input: [2, -1, 2, 3, 4, -5],
    expected: [10, 11],
  },
  {
    name: "uses the least negative value when all numbers are negative",
    input: [-2, -3, -1, -4],
    expected: [-1, -1],
  },
  {
    name: "allows the subsequence sum to beat the best contiguous segment",
    input: [1, -2, 0, 3],
    expected: [3, 4],
  },
  {
    name: "restarts the best subarray after a large negative drop",
    input: [-1, 2, 3, -9, 5, 6],
    expected: [11, 16],
  },
] as const;
