...
| Making Anagrams | HackerRank | [`solve/making-anagrams`](https://github.com/guilhermeledes/algorithms-study/tree/solve/making-anagrams) | [folder](https://github.com/guilhermeledes/algorithms-study/tree/solve/making-anagrams/studies/problems/making-anagrams) |
...
| Queue using Two Stacks | HackerRank | [`solve/queue-using-two-stacks`](https://github.com/guilhermeledes/algorithms-study/tree/solve/queue-using-two-stacks) | [folder](https://github.com/guilhermeledes/algorithms-study/tree/solve/queue-using-two-stacks/studies/problems/queue-using-two-stacks) |
